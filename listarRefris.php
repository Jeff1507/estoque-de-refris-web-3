...
<body>
    <section class="flex items-center justify-center min-h-screen">
        <div class="flex flex-col gap-5 p-5 border-2 border-gray-300 rounded-lg">
            ...
            <a 
                ...
                class="group w-max relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-purple-500 px-6 font-medium text-white duration-500"
            >
