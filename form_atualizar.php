...
<body>
    <section class="flex items-center justify-center min-h-screen">
        <div class="w-[400px] flex flex-col gap-8">
            ...
            <form method="POST" action="atualizaRefri.php" class="flex flex-col gap-5">
                ...
                <div class="relative">
                    <input 
                        ...
                        id="marca"
                        required 
                        value="<?php echo $refriSelecionado['marca']; ?>"
                ...
                <div class="relative">
                    <input 
                        ...
                        id="sabor"
                        required 
                        value="<?php echo $refriSelecionado['sabor']; ?>"
                        class="block rounded-md px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-transparent border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-500 focus:outline-none focus:ring-0 focus:border-purple-600 peer"
                    />
                    <label 
                        for="sabor"
                ...
                <div class="relative">
                    <input 
                        ...
                        id="quantidade"
                        required 
                        value="<?php echo $refriSelecionado['quantidade']; ?>"
                        class="block rounded-md px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-transparent border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-500 focus:outline-none focus:ring-0 focus:border-purple-600 peer"
                    />
                    <label 
                        for="quantidade"
